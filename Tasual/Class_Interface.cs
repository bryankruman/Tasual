...
{
	/*
	#1: Version Check and Information
	...
	#2: Registration (Should we use this or just rely upon web registration and provide an auth token?)
	...
	Outgoing (from server): Pulse response
		...
		2. Boolean: shouldsync: Whether or not the client should send its data to the server and the server should send its data to the client
